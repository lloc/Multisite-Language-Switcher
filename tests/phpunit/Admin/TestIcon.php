...
final class TestIcon extends MslsUnitTestCase {
	...
	private function IconFactory( $post ): Icon {
		return ( new Icon( $post->post_type ) )
			->set_path()
	...
	public function test_get_a_empty_post(): void {
		...
		$this->assertInstanceOf( Icon::class, $obj->set_href( 0 ) );
	...
	public function test_set_id_with_null_constructor(): void {
		...
		$this->assertInstanceOf( Icon::class, $obj->set_id( 1 ) );
	}
	...
	public function test_set_origin_language(): void {
		...
		$this->assertInstanceOf( Icon::class, $obj->set_origin_language( 'it_IT' ) );
	}
