...
use lloc\Msls\Admin\IconTaxonomy;
use lloc\MslsTests\MslsUnitTestCase;

final class TestIconTaxonomy extends MslsUnitTestCase {
	...
	public function test_set_href(): void {
		...
		$this->assertInstanceOf( IconTaxonomy::class, $obj->set_href( 42 ) );
	...
	public function test_set_href_empty(): void {
		...
		$this->assertInstanceOf( IconTaxonomy::class, $obj->set_href( 0 ) );
