...
final class TestPostTag extends MslsUnitTestCase {
	...
	private function MslsPostTagFacory(): PostTag {
		...
		return new PostTag( $options, $collection );
	}
	...
	public function test_add_input(): void {
		...
		Actions\expectDone( PostTag::MSLS_ADD_INPUT_ACTION );
	...
	public function test_the_input_no_blogs(): void {
		...
		$value = ( new PostTag( $options, $collection ) )->the_input( null, '', '' );
